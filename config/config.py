...
def get_parser():
    ...
    parser.add_argument('--pretrained-model-weight-path',default='./pretrained',type=str)
    ...
    parser.add_argument('--model-architecture',default='version1',type=str,choices=['version0','version1','version1_init','version1_osh','version1_osh_origin'])
    parser.add_argument('--backbone-architecture',default='resnet50',type=str,choices=['resnet18','resnet34','resnet50','efficient_b0', 'efficient_b1', 'efficient_b2','resnet101','vit_b_16','vit_b_16_384','swin_b','convnext_b'])
    ...
    parser.add_argument('--dataset-info-path',default='/home/oem/datasets/filename_list/',type=str)
