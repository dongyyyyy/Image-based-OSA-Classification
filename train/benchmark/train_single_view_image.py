...
if __name__ == '__main__':
    ...
    for fold in range(args.k_fold):
        ...
        # print('model : ', model)
        if args.backbone_architecture != 'vit_b_16_384':
        ...
        train_dataset = AHI_classification_folder(args=args, dataset_list = image_train_list_with_label, image_view = args.image_view, size=args.image_size,is_train=True)
