...
from model.Attention.TVA import two_views_MHSA, two_views_MHCA, two_views_MHDA
...
if __name__ == '__main__':
    ...
    for fold in range(args.k_fold):
        ...
        if args.MHDA:
            print('MHDA !!')
            model = two_views_MHDA(backbone1=backbone1, backbone2=backbone2, backbone_freezing=args.backbone_freezing,
            ...
            if args.cross_attention:
                print('MHCA !!')
                model = two_views_MHCA(backbone1=backbone1, backbone2=backbone2, backbone_freezing=args.backbone_freezing,shared_attention=args.shared_attention,
                                backbone_output_dim=output_dim1,emb_size=args.emb_size, num_patches=num_patches,depth=args.depth,
                                positional_embedding=args.positional_embedding,cls_token=args.cls_token,last_gelu=args.last_gelu,
                                heads=args.num_heads,dropout=args.dropout,emb_dropout=args.emb_dropout, class_num=args.num_classes)
            else:
                print('MHSA !!')
                model = two_views_MHSA(backbone1=backbone1, backbone2=backbone2, backbone_freezing=args.backbone_freezing,shared_attention=args.shared_attention,
                                backbone_output_dim=output_dim1,emb_size=args.emb_size, num_patches=num_patches,depth=args.depth,
                                positional_embedding=args.positional_embedding,cls_token=args.cls_token,last_gelu=args.last_gelu,
                                heads=args.num_heads,dropout=args.dropout,emb_dropout=args.emb_dropout, class_num=args.num_classes)
