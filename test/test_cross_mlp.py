...
from model.Cross_MLP.Cross_MLP import Cross_MLP_model, Cross_MLP_model_vesrion2
...
from config.config_cross_mlp_test import get_parser
...
if __name__ == '__main__':
    ...
    for fold in range(args.k_fold):
        ...
        if fold + 1== 1:
            ...
            #########################################################
            if args.model_architecture == 'version1':
                model = Cross_MLP_model(backbone1 = backbone1, backbone2 = backbone2,
                            backbone_freezing=args.backbone_freezing,
                            backbone_output_dim=args.backbone_output_dim, emb_freezing=args.emb_freezing,
                            emb_size = args.emb_size,
                            inversed_cross_mlp=args.inversed_cross_mlp, depth=args.depth,
                            dropout=args.dropout,last_gelu=args.last_gelu,
                            class_num=args.num_classes)
            elif args.model_architecture == 'version2':
                model = Cross_MLP_model_vesrion2(backbone1 = backbone1, backbone2 = backbone2,
                                backbone_freezing=args.backbone_freezing,
